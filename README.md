...
In order to perform this task, the research exploits the Local Interpretable Model-agnostic
Explanations(LIME), a Phyton library that explains how the classifiers perform on
data, and Latent Dirichlet Allocation(LDA), an unsupervised method based on topic
modeling.

## Keyword
hate speech, classification, supervised learning, LIME, unsupervised learning,
LDA, dictionary
